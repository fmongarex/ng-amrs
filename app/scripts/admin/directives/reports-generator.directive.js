...
(function () {
    ...
    angular
        .module('app.admin')
        .directive('reportGenerator', directive);
    function directive() {
        return {
            restrict: "E",
            scope: { reportName: "@"
    ...
    reportGeneratorController.$nject =

      ['$rootScope', '$scope', '$stateParams', 'EtlRestService', 'HivSummaryIndicatorService', 'moment', '$filter', '$state'
      ,'$timeout','$modal'];

    function reportGeneratorController($rootScope, $scope, $stateParams, EtlRestService, HivSummaryIndicatorService, moment,
