...
(function () {
    ...
    angular
        .module('app.admin')
        .directive('hivSummaryIndicators', directive);
    function directive() {
        return {
            restrict: "E",
            scope: { reportName: "@",
            ...
            controller: hivSummaryIndicatorsController,
            templateUrl: "views/admin/hiv-indicators-directive.html"
        };
    }

    hivSummaryIndicatorsController.$nject =

      ['$rootScope', '$scope', '$stateParams', 'EtlRestService', 'HivSummaryIndicatorService', 'moment', '$filter', '$state'
      ,'$timeout','$modal'];

    function hivSummaryIndicatorsController($rootScope, $scope, $stateParams, EtlRestService, HivSummaryIndicatorService, moment,
      ...
      function loadHivSummaryIndicators() {
        ...
        if ($scope.reportName && $scope.reportName !== ''
          ...
          var params = Object.assign(localParams,$scope.reportParameters);
          EtlRestService.getReportByName($scope.reportName,params,onFetchHivSummaryIndicatorsSuccess, onFetchHivSummaryIndicatorsError);
